...
def get_converter() -> UASTConverter:
    """Return the cached JavaScript UAST converter."""
...
def get_language_config() -> LanguageConfig:
    """Return the JavaScript parser configuration."""

    return LanguageConfig(
        name=SourceLanguage.JAVASCRIPT.value,
        language_factory=get_language,
        converter_factory=get_converter,
        extensions=list(
            SOURCE_LANGUAGE_EXTENSIONS[SourceLanguage.JAVASCRIPT],
        ),
    )
